...
func verifyCreation(
	...
	infrastructureIdentifier.SnatTableID = pointer.StringPtr(describeNatGatewaysOutput.NatGateways.NatGateway[0].SnatTableIds.SnatTableId[0])
	...
	Expect(describeEipAddressesOutput.EipAddresses.EipAddress[0].InternetChargeType).To(Equal(DefaultInternetChargeType))
